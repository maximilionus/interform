...
class BaseLangTest():
    ...
    def test_refresh_safe(self):
        ...
        self.language_object.commit()
        self.language_object["root"]['nested_dict_refresh_test']["will_stay_too"] = "wait..."
        self.language_object.refresh()

        assert self.language_object["root"]['nested_dict_refresh_test'].get("will_stay", None) is not None and \
               self.language_object["root"]['nested_dict_refresh_test'].get("will_stay_too", None) is not None
